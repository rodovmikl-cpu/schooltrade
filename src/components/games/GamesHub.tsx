...
const GAMES = [
  ...
  { key: "runner" as GameKey, label: "🏃 ריצת מטרו", desc: "רוץ, קפוץ ואסוף מטבעות", color: "from-orange-500/20 to-amber-500/10 border-orange-500/40 hover:border-orange-400/70" },
...
export const GamesHub = ({ userCode, userName }: GamesHubProps) => {
  ...
  const renderArcade = () => {
    switch (activeGame) {
      ...
      case "runner": return <GameWithLeaderboard gameKey="runner" userCode={userCode} title="🏃 ריצת מטרו"><RunnerGame userCode={userCode} userName={userName} /></GameWithLeaderboard>;
